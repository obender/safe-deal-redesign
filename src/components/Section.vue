...
export default {
  ...
  computed: {
    isMobile() {
      return this.winWidth < this.mobileWidth;
    },
  },
  created() {
...
.section__item__card {
  ...
  box-shadow: 0 1px 15px #d3d3d37e;
}
.section__item__card__image {
  width: 100%;
}
...
.section__item__title--small {
  font-size: 35px;
}
.section__item__title--big {
  font-size: 50px;
}
